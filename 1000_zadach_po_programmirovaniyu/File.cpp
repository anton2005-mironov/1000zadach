...
void File4() {
	string fileNames[4];
	cout << "¬ведите имена четырех файлов:\n";
	for (int i = 0; i < 4; ++i) {
		cout << "»м€ файла " << (i + 1) << ": ";
		cin >> fileNames[i];
	}
	...
	cout << " оличество найденных файлов: " << count << endl;
...
void File64() {
	string a0 = "C:\\Users\\Anton\\source\\repos\\јнтон C++\\1000_zadach_po_programmirovaniyu\\example.txt";
	string a1 = "C:\\Users\\Anton\\source\\repos\\јнтон C++\\1000_zadach_po_programmirovaniyu\\example1.txt";
...
void File67() {
	...
	ofstream daysFile("C:\\Users\\Anton\\source\\repos\\јнтон C++\\1000_zadach_po_programmirovaniyu\\days.txt", ios_base::trunc);
	for (int day : days) {
		daysFile << day << endl;
	}
	daysFile.close();
